...
df <- read_csv('./fao/Emissions_totals/Emissions_Totals_E_All_Data_NOFLAG2.csv')
...
meanEmissions_farmOnly <- df_farmOnly %>% dplyr::select(Y2018,Y2019,Y2020) %>% summarize(m2018=mean(Y2018,na.rm=TRUE),m2019=mean(Y2019,na.rm=TRUE),m2020=mean(Y2020,na.rm=TRUE))
